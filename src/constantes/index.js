export const initialStatus = { type: "", message: "" };
export const MIN_PASSWORD_LENGTH = 8;
export const passwordChecksFor = (value) => {
  const pwd = value || "";
  return [
    {
      id: "length",
      label: `Minimo ${MIN_PASSWORD_LENGTH} caracteres`,
      ok: pwd.length >= MIN_PASSWORD_LENGTH,
    },
    { id: "upper", label: "Una mayuscula", ok: /[A-Z]/.test(pwd) },
    { id: "lower", label: "Una minuscula", ok: /[a-z]/.test(pwd) },
    { id: "number", label: "Un numero", ok: /\d/.test(pwd) },
    { id: "symbol", label: "Un simbolo", ok: /[^A-Za-z0-9]/.test(pwd) },
  ];
};
